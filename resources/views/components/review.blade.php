<div class="container my-5 py-5">
    ...
    <div id="reviewCarousel" class="carousel slide pt-5" data-bs-ride="carousel" data-bs-interval="5000">
                    ...
                    <div class="col-md-4">
                        <div class="review-card">
                            ...
                            <div class="row text-start">
                                ...
                                <div class="col-4">
                                    <h6>Natalie F.</h6>
                                    <p class="text-muted">ATLANTA, GA</p>
                                </div>
                            </div>
